...
#define CMD_FWD     M(KC_CMD_FWD)               // Macro for Cmd-]
#define CMD_BACK    M(KC_CMD_BACK)              // Macro for Cmd-[
/* Qwerty
 *
 * ,---------+------+------+------+------+------+------+------+------+------+------+------+------.
 ...
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * |  Sft/BS  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |  Sft/Ent  |
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   RGUI |  Alt  |  GUI  | Lower | TC/Space | TC/Enter |  Raise  |  Vol-  |  Vol+  |   Play   |
 *  `-------+-------+-------+-------+---^^^----+---^^^----+---------+--------+--------+----------'
 */
...
[_QWERTY] = KEYMAP_JD45(
/*,--------+-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
    HPR_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_BSLS, KC_BSPC,
/*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------|*/
...
/*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
    KC_RGUI  ,  KC_LALT  ,  KC_LGUI  ,   LOWER   , LT_TC(KC_SPC), LT_TC(KC_ENT),    RAISE  ,  KC_GRV  ,  KC_RGUI  , KC_MPLY),
/*`----------+-----------+-----------+-----------+----^^^----+----^^^----+-----------+-----------+-----------+--------'*/
 ...
 * |----------`------`------`------`------`------`------`------`------`------`------`------------|
 * | Sft/BS    |   Z  |   X  |   C  |   V  |   B  |   K  |   M  |   ,  |   .  |   /  |  Sft/Ent  |
 * |-----------`------`------`------`------`-----'-------`------`------`------`------`-----------|
 * |   RGUI |  Alt  |  GUI  | Lower | TC/Space | TC/Enter |  Raise  |   ~    |  RGUI  |   Play   |
 *  `-------+-------+-------+-------+---^^^----+---^^^----+---------+--------+--------+----------'
 */
[_COLEMAK] = KEYMAP_JD45(
/*,--------+-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
    HPR_TAB,   KC_Q,    KC_W,    KC_F,    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y, KC_SCLN, KC_BSLS, KC_BSPC,
/*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------|*/
...
/*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
    KC_RGUI  ,  KC_LALT  ,  KC_LGUI  ,   LOWER   ,   LT_TC(KC_SPC)   ,   LT_TC(KC_ENT)   ,    RAISE  ,  KC_VOLD  ,  KC_VOLU  , KC_MPLY),
/*`----------+-----------+-----------+-----------+----^^^----+----^^^----+-----------+-----------+-----------+--------'*/
...
[_LOWER] = KEYMAP_JD45(
/*,--------+-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
    CMD_TAB,KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, KC_BSPC,
/*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------|*/
...
/*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
     _______,     BACKLIT,    _______,    _______,  _______  ,  _______  ,  _______,  CS_TAB,    CTL_TAB, KC_MUTE),
/*`----------+-----------+-----------+-----------+----^^^----+----^^^----+-----------+-----------+-----------+--------'*/
...
/*|----------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`---------------|*/
      _______,    BACKLIT,    _______,    _______,  _______  ,  _______  ,    _______,    CMD_BACK, CMD_FWD, KC_MUTE),
/*`----------+-----------+-----------+-----------+----^^^----+----^^^----+-----------+-----------+-----------+--------'*/
...
/*,--------+-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
    CTL_TAB,CMD_TAB, ALT_TAB, AG_FIND, KC_LSFT, AG_AGAIN, KC_INS, KC_HOME,   KC_UP,  KC_END, KC_BSPC, _______, _______,
/*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------|*/
...
/*,--------+-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------.*/
    _______,_______, KC_ACL0, _______, _______, _______, _______, KC_WH_L, KC_MS_U, KC_WH_R, KC_BTN1, _______, _______,
/*|--------`-------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------`--------|*/
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt)
{
    ...
    switch (id) {
      ...
      case KC_CMD_BACK:
        return (record->event.pressed ? MACRO( D(LGUI), D(LBRACKET), END ) : MACRO( U(LBRACKET), END ));
      case KC_CMD_FWD:
        return (record->event.pressed ? MACRO( D(LGUI), D(RBRACKET), END ) : MACRO( U(RBRACKET), END ));
    }
